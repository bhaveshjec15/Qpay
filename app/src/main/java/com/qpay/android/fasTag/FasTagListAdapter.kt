...
import com.qpay.android.fasTag.FasTagListAdapter.ViewHolder
import com.squareup.picasso.Picasso
import kotlinx.coroutines.*

class FasTagListAdapter(val mContext: Context, private val mList: List<FasTagBillerListModel>) :
  ...
  override fun onBindViewHolder(holder: ViewHolder, position: Int) {
    ...
    holder.layoutMain.setOnClickListener {
      val intent = Intent(mContext, FasTagDetailsActivity::class.java)
