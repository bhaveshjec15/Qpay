package com.qpay.android.rechargePrepad.internet
...
import com.qpay.android.rechargePrepad.internet.InternetListAdapter.ViewHolder
...
class InternetListAdapter(val mContext: Context, private val mList: List<InternetModel>) :
