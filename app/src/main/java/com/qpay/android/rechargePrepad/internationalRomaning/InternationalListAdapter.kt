package com.qpay.android.rechargePrepad.internationalRomaning
...
import com.qpay.android.rechargePrepad.internationalRomaning.InternationalListAdapter.ViewHolder
...
class InternationalListAdapter(val mContext: Context, private val mList: List<InternationalRomaningModel>) :
  ...
  override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
    ...
    val view = LayoutInflater.from(parent.context)
      .inflate(R.layout.item_international, parent, false)
    ...
    apiInterface.enqueue(object : Callback<ResponseBody> {
      override fun onResponse(call: Call<ResponseBody>, response: Response<ResponseBody>) {
        ...
        if (statusCode == 200) {
          ...
          DesignerToast.defaultToast(mContext,message, Gravity.BOTTOM,Toast.LENGTH_SHORT);
        }
