package com.qpay.android.rechargePrepad.fullTalkTime
...
import com.qpay.android.rechargePrepad.fullTalkTime.FullTalkTimeListAdapter.ViewHolder
...
class FullTalkTimeListAdapter(val mContext: Context, private val mList: List<FullTalkTimeModel>) :
  ...
  override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
    ...
    val view = LayoutInflater.from(parent.context)
      .inflate(R.layout.item_full_talk_time_pack, parent, false)
  ...
  override fun onBindViewHolder(holder: ViewHolder, position: Int) {
    ...
    holder.description.text = mContext.resources.getString(R.string.Rs)+" "+ItemsViewModel.talktime
    holder.validity.text = mContext.resources.getString(R.string.Rs)+" "+ItemsViewModel.talktime
          ...
          for (i in 0..ss) {
            ...
            if (selectedOperatorName.equals(billerName, true)) {
              ...
              var params = PaymentValidationRequestModel(
                ...
                getStringShrd(mContext, CommonUtils.userName),
