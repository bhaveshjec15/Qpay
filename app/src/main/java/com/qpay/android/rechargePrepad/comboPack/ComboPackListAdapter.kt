...
import com.qpay.android.rechargePrepad.comboPack.ComboPackListAdapter.ViewHolder
...
class ComboPackListAdapter(val mContext: Context, private val mList: List<ComboPackModel>) :
  ...
  override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
    ...
    val view = LayoutInflater.from(parent.context)
      .inflate(R.layout.item_combo_pack, parent, false)
