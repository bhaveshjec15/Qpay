package com.qpay.android.rechargePrepad.special
...
import com.qpay.android.rechargePrepad.special.SpecialListAdapter.ViewHolder
...
class SpecialListAdapter(val mContext: Context, private val mList: List<SpecialModel>) :
