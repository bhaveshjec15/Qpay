...
class SendToMobileActivity : AppCompatActivity() {
  private lateinit var binding: ActivitySendToMobileBinding
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    binding = DataBindingUtil.setContentView(this, R.layout.activity_send_to_mobile)
